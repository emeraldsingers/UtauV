...
namespace OpenUtau.Core.Editing {
    ...
    public class AutoPitchConfigLegacy {
    ...
    public class AutoPitchEditLegacy : BatchEdit {
        public string Name => "AutoPitch (legacy)";
        ...
        private void LoadConfig() {
            ...
            try {
                ...
                if (!File.Exists(configPath)) {
                    var defaultConfig = new AutoPitchConfigLegacy();
                    ...
                    var config = JsonSerializer.Deserialize<AutoPitchConfigLegacy>(json, new JsonSerializerOptions {
        ...
        public void Run(UProject project, UVoicePart part, List<UNote> selectedNotes, DocManager docManager) {
            ...
            try {
                using (var outputs = _session.Run(inputs)) {
                    ...
                    ApplyPitchBends(part, notes, pitchParams, docManager);
        ...
        private void ApplyPitchBends(UVoicePart part, List<UNote> notes, float[] pitchParams, DocManager docManager) {
            int seqLength = notes.Count;
            ...
            for (int i = 0; i < seqLength; i++) {
                ...
                docManager.ExecuteCmd(new SetPitchPointsCommand(part, note, pitch));
            }
        }
