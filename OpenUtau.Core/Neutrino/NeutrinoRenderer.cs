...
namespace OpenUtau.Core.Neutrino {
    public class NeutrinoRenderer : HTSLabelRenderer {
        ...
        public override Task<RenderResult> Render(RenderPhrase phrase, Progress progress, int trackNo, CancellationTokenSource cancellation, bool isPreRender, RenderPhraseEvents? renderEvents = null) {
            var task = Task.Run(() => {
                lock (lockObj) {
