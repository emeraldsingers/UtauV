...
<<<<<<< HEAD
    [Phonemizer("Japanese CVVC Phonemizer", "JA CVVC", "TUBS | asoqwer",language:"JA")]
=======
...
>>>>>>> stakira/master
    public class JapaneseCVVCPhonemizer : Phonemizer {
        ...
        static readonly string[] consonants = new string[] {
            ...
            "h=は,はぃ,へ,ほ,ほぅ,h",
            "k=か,く,くぃ,け,こ,k",
            "j=じ,じぇ,じゃ,じゅ,じょ,ぢ,ぢぇ,ぢゃ,ぢゅ,ぢょ,j",
            "m=ま,む,むぃ,め,も,m",
            "n=な,ぬ,ぬぃ,ね,の,n",
            "p=ぱ,ぷ,ぷぃ,ぺ,ぽ,p",
            "s=さ,す,すぃ,せ,そ,s",
            "sh=し,しぇ,しゃ,しゅ,しょ,sh",
            "t=た,て,と,とぃ,とぅ,t",
            "v=ヴ,ヴぁ,ヴぃ,ヴぅ,ヴぇ,ヴぉ,v",
            "ky=き,きぇ,きゃ,きゅ,きょ,ky",
            "w=うぃ,うぅ,うぇ,うぉ,わ,ゐ,ゑ,を,ヰ,ヱ,w",
            "y=いぃ,いぇ,や,ゆ,よ,y",
            "z=ざ,ず,ずぃ,ぜ,ぞ,z",
            "dz=づ,づぃ,dz",
            "my=み,みぇ,みゃ,みゅ,みょ,my",
            "ng=ガ,ギ,グ,ゲ,ゴ,ギェ,ギャ,ギュ,ギョ,カ゜,キ゜,ク゜,ケ゜,コ゜,キ゜ェ,キ゜ャ,キ゜ュ,キ゜ョ,ng",
            "l=ラ,ル,レ,ロ,l",
            "・=・あ,・い,・う,・え,・お,・ん,・を,・ン",
        };
