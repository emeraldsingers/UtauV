...
namespace OpenUtau.App.Views {
    public partial class MainWindow : Window, ICmdSubscriber {
        ...
        void OnMenuTransposeTracks(object sender, RoutedEventArgs e) {
            var project = DocManager.Inst.Project;
            var tracksViewModel = viewModel.TracksViewModel;
            var dialog = new TypeInDialog {
            ...
            if (ProjectExts.Contains(FirstExt) || AudioExts.Contains(FirstExt)) {
                ...
                if (projectFiles.Length > 0) {
                    ...
                    if (viewModel.Page == 1) {
                        ...
                        openAs.Closed += delegate { tcs.TrySetResult(!cancelled); };
                        openAs.Show();
        ...
        static bool IsImportedVocalModeCurve(string abbr) {
            ...
            return abbr != Ustx.DYN && abbr != Ustx.PITD && abbr != Ustx.TENC &&
                ...
                abbr != Ustx.SHFC && abbr != Ustx.CLR && abbr != Ustx.XSYC &&
                abbr != "opec";
        }
