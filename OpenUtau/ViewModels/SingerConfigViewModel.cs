    ...
    class SingerConfigViewModel : ViewModelBase {
        ...
        public SingerConfigViewModel(USinger singer) {
            ...
            foreach (var language in languageList) {
                LocalizedNames.Add(new LocalizedName(language.Name, language.DisplayName, string.Empty));
            }
            ...
            PhonemizerList = PhonemizerFactory.GetAll().Select(factory => factory.ToString()).ToList();
            ...
            if (config != null) {
                if (config.LocalizedNames != null) {
                    foreach (var name in config.LocalizedNames) {
                ...
                var factory = PhonemizerFactory.GetAll().FirstOrDefault(factory => factory.type.FullName == config.DefaultPhonemizer);
        ...
        public bool Save() {
            try {
                ...
                foreach (var n in LocalizedNames) {
                ...
                var factory = PhonemizerFactory.GetAll().FirstOrDefault(factory => factory.ToString() == DefaultPhonemizer);
