...
namespace OpenUtau.App.ViewModels {
    ...
    public partial class NotesViewModel : ViewModelBase, ICmdSubscriber {
        ...
        [Reactive] public partial double PitchEditDim { get; set; } = 59;
        [Reactive] public partial bool ShowNoteParams { get; set; }
        [Reactive] public partial bool ShowExpressions { get; set; }
        [Reactive] public partial bool ShowPlaybackVerticalFollow { get; set; }
        ...
        [Reactive] public partial bool ShowPlaybackNoteOrbit { get; set; }
        [Reactive] public partial bool ShowPlaybackPortraitSpin { get; set; }
        [Reactive] public partial bool ShowRainbowEffect { get; set; }
        ...
        public NotesViewModel() {
            ...
            ShowPlaybackNoteOrbit = Preferences.Default.ShowPlaybackNoteOrbit;
            this.WhenAnyValue(x => x.ShowPlaybackNoteOrbit)
                .Skip(1)
                .Subscribe(showPlaybackNoteOrbit => {
                    Preferences.Default.ShowPlaybackNoteOrbit = showPlaybackNoteOrbit;
                    Preferences.Save();
                });
            ShowPlaybackPortraitSpin = Preferences.Default.ShowPlaybackPortraitSpin;
            this.WhenAnyValue(x => x.ShowPlaybackPortraitSpin)
                .Skip(1)
                .Subscribe(value => {
                    Preferences.Default.ShowPlaybackPortraitSpin = value;
                    Preferences.Save();
                });
